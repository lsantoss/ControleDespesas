...
{
    public class ObterArquivoPagamentoCommandTeste : BaseTest
    {
        private ObterArquivoPagamentoCommand _command;

        [SetUp]
        public void Setup() => _command = new SettingsTest().PagamentoObterArquivoPagamentoCommand;
